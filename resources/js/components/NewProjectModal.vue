            ...
            <div class="flex">
                <div class="flex-1 mr-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" class="border border-muted-light p-2 text-xs block w-full rounded" :class="errors.description ? 'border-error' : 'border-muted-light'" rows="7" v-model="form.description"></textarea>
